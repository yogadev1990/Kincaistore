    ...
    <q-card flat class="bg-white" style="max-width:420px;width:100%;">
      ...
      <div class="column q-gutter-y-sm">
        ...
        <div class="column q-gutter-y-sm text-center q-mt-xs">
          <div v-if="isRegister">Sudah punya akun <q-btn no-caps color="blue-7" padding="xs" flat :disabled="isLoading" label="Login Disini" @click="formType ='login'"></q-btn></div>
          <div v-if="!isRegister">
            <div>
              Belum punya akun <q-btn no-caps color="blue-7" padding="xs" flat :disabled="isLoading" label="Daftar Disini" @click="formType ='register'"></q-btn>
            </div>
            <div>
