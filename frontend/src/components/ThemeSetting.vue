          ...
          <div>
            ...
            <q-list dense>
              <q-item>
                ...
                <q-item-section side v-if="config">
                  <div class="q-gutter-x-sm">
                    <q-btn @click="changeHomeViewMode('grid')" label="Grid" size="sm" unelevated :color="config.home_view_mode == 'grid' ? 'blue-7' : 'grey-6'" dense icon="grid_view">
                      <q-tooltip>
                        Grid Mode
                      </q-tooltip>
                    </q-btn>
                    <q-btn @click="changeHomeViewMode('list')" label="List" size="sm" unelevated :color="config.home_view_mode == 'list' ? 'blue-7' : 'grey-6'" dense icon="view_list">
                      <q-tooltip>
                        List Mode
                      </q-tooltip>
                    </q-btn>
              ...
              <q-item>
                ...
                <q-item-section side>
                  <div class="q-gutter-x-sm">
                    <q-btn @click="changeProductViewMode('grid')" label="Grid" size="sm" unelevated :color="config.product_view_mode == 'grid' ? 'blue-7' : 'grey-6'" dense icon="grid_view">
                      <q-tooltip>
                        Grid Mode
                      </q-tooltip>
                    </q-btn>
                    <q-btn @click="changeProductViewMode('list')" label="List" size="sm" unelevated :color="config.product_view_mode == 'list' ? 'blue-7' : 'grey-6'" dense icon="view_list">
                      <q-tooltip>
                        List Mode
                      </q-tooltip>
                    </q-btn>
          ...
          <div>
            ...
            <q-list dense>
                <q-item dense>
                  ...
                  <q-item-section side>
                    <q-toggle v-model="is_whatsapp_checkout" color="blue-6"></q-toggle>
                  </q-item-section>
                </q-item>
                <q-item dense>
                  <q-item-section>
                  ...
                  <q-item-section side>
                    <q-toggle v-model="is_guest_checkout" color="blue-6"></q-toggle>
                  </q-item-section>
                </q-item>
              </q-list>
          </div>
