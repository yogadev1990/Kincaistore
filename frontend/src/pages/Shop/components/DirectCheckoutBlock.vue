  ...
  <div>
    <q-form @submit.prevent="submitOrder">
      <q-card class="full-width">
        <div class="text-weight-bold q-py-sm q-px-md bg-blue-6 text-white text-md">Checkout Whatsapp</div>
        <q-card-section>
          <q-input 
          dense
        ...
        <q-card-actions class="justify-end q-pa-md">
            <q-btn unelevated color="grey-3" text-color="blue-7" type="button" :disabled="loading" label="Batal" @click.prevent="$emit('close')" no-caps></q-btn>
            <q-btn type="submit" :loading="loading" :disabled="!canDirectCheckout" unelevated label="Order Sekarang" color="blue-6" no-caps></q-btn>
        </q-card-actions>
      </q-card>
    </q-form>
