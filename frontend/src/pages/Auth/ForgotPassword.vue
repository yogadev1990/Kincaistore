      ...
      <q-card flat class="q-pt-sm" style="background:rgb(255 255 255 / 71%);">
        <q-card-section>
          <div class="text-grey-7 q-pa-sm" v-if="!isHasRequest">
           Lupa kata sandi? Silahkan masukan email yang terdaftar di situs ini, sistem akan mengirimkan kode token ke alamat email anda. 
            ...
            <div class="text-grey-7 q-pa-sm" v-if="isHasRequest">
              ...
              <router-link no-caps flat class="text-blue-7" :to="{name: 'ResetPassword'}">Klik disini untuk memasukan kode token</router-link>
            </div>
          ...
          <div class="text-center q-mt-sm"> 
            <q-btn :disabled="isLoading" no-caps flat color="blue-7" :to="{name: 'Login'}">Kembali ke halaman login</q-btn>
          </div>
        </q-card-section>
      </q-card>
    </div>
