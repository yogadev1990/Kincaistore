  ...
  <q-page class="flex flex-center relative">
    ...
    <div style="max-width: 450px;width:100%;" class="q-pa-sm">
      <div class="flex justify-center">
        ...
        <img v-else src="/icon/pp.png" style="width:auto;height:75px;object-fit:contain;max-width:150px;" />
      </div>
      ...
      <q-card flat class="q-pt-sm" style="background:rgb(255 255 255 / 71%);">
        ...
        <div class="column">
          ...
          <div>
          Sudah punya akun <q-btn no-caps color="blue-7" padding="xs" flat :disabled="isLoading" label="Login Disini" :to="{ name: 'Login'}"></q-btn>
          </div>
        </div>
        </q-card-section>
      </q-card>
