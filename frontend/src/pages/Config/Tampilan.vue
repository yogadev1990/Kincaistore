...
<q-card flat>
  ...
  <q-list>
    <q-item>
      ...
      <q-item-section side>
        <div class="q-gutter-x-sm">
          <q-btn @click="changeHomeViewMode('grid')" label="Grid Mode" size="sm" unelevated :color="form.home_view_mode == 'grid' ? 'blue-7' : 'grey-6'" dense icon="grid_view">
            <q-tooltip>
              Grid Mode
            </q-tooltip>
          </q-btn>
          <q-btn @click="changeHomeViewMode('list')" label="List Mode" size="sm" unelevated :color="form.home_view_mode == 'list' ? 'blue-7' : 'grey-6'" dense icon="view_list">
            <q-tooltip>
              List Mode
            </q-tooltip>
          </q-btn>
    ...
    <q-item>
      ...
      <q-item-section side>
        <div class="q-gutter-x-sm">
          <q-btn @click="changeProductViewMode('grid')" label="Grid Mode" size="sm" unelevated :color="form.product_view_mode == 'grid' ? 'blue-7' : 'grey-6'" dense icon="grid_view">
            <q-tooltip>
              Grid Mode
            </q-tooltip>
          </q-btn>
          <q-btn @click="changeProductViewMode('list')" label="List Mode" size="sm" unelevated :color="form.product_view_mode == 'list' ? 'blue-7' : 'grey-6'" dense icon="view_list">
            <q-tooltip>
              List Mode
            </q-tooltip>
          </q-btn>
     ...
     <q-item class="q-mt-md">
      ...
      <q-item-section side top>
        <q-toggle v-model="form.is_notifypro" :label="form.is_notifypro? 'ON' : 'OFF'" left-label color="blue-6"></q-toggle>
      </q-item-section>
    </q-item>
