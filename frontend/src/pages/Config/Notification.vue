  ...
  <q-card flat>
    <q-card-section>
      <div class="flex items-center justify-between">
        ...
        <div class="q-px-sm rounded-borders text-white" :class="config && config.is_telegram_ready? 'bg-blue-7' : 'bg-grey-6'">{{ config && config.is_telegram_ready? 'Active' : 'Disabled' }}</div>
      </div>
